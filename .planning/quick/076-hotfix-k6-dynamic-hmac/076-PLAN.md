...
- **Secret del servidor** (`app/core/config.py` L38): `os.getenv("WHATSAPP_APP_SECRET", "secreto_de_aplicacion_para_firmas_hmac")`
...
<task type="auto">
  ...
  <action>
    ...
    2. Capturar secret: `const secret = __ENV.WHATSAPP_APP_SECRET || 'secreto_de_aplicacion_para_firmas_hmac';`
